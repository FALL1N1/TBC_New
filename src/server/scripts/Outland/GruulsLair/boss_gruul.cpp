            ...
            void UpdateAI(uint32 diff)
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_HURTFUL_STRIKE:
                        if (Unit* target = SelectTarget(SELECT_TARGET_MAXTHREAT, 1, 5.0f))
...
class spell_gruul_ground_slam : public SpellScriptLoader
{
    public:
        ...
        class spell_gruul_ground_slam_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gruul_ground_slam_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_gruul_shatter : public SpellScriptLoader
{
    public:
        ...
        class spell_gruul_shatter_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gruul_shatter_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
