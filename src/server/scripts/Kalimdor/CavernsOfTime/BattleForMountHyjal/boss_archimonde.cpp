...
public:
    ...
    struct npc_ancient_wispAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            ArchimondeGUID.Set(instance->GetGuidData(DATA_ARCHIMONDE));
...
public:
    ...
    struct boss_archimondeAI : public hyjal_trashAI
    {
        ...
        void JustSummoned(Creature* summoned)
        {
            ...
            {
                DoomfireSpiritGUID.Set(summoned->GetGUID());
            }
            ...
            if (summoned->GetEntry() == CREATURE_DOOMFIRE)
            {
                ...
                summoned->CastSpell(summoned, SPELL_DOOMFIRE, true);
        ...
        void WaypointReached(uint32 /*waypointId*/, uint32 /*none*/) override { }
    };
};
