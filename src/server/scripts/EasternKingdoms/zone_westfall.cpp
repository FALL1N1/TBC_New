...
public:
    ...
    bool OnQuestAccept(Player* player, Creature* creature, const Quest* quest)
    {
        if (quest->GetQuestId() == QUEST_TOME_VALOR)
        {
            ...
            if (EscortAI* pEscortAI = CAST_AI(npc_daphne_stilwell::npc_daphne_stilwellAI, creature->AI()))
    ...
    struct npc_daphne_stilwellAI : public EscortAI
    {
        npc_daphne_stilwellAI(Creature* creature) : EscortAI(creature), summons(me) { }
        ...
        void WaypointReached(uint32 waypointId, uint32)
        {
            ...
            switch (waypointId)
            {
                case 4:
                    ...
                    me->HandleEmoteCommand(ANIM_EMOTE_USE_STANDING);
                    break;
                case 7:
