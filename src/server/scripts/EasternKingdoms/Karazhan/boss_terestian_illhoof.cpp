...
public:
    ...
    struct npc_kilrekAI : public ScriptedAI
    {
        ...
        { 
            TerestianGUID.Set(instance->GetObjectGuid(DATA_TERESTIAN));
            if (TerestianGUID)
            {
...
public:
    ...
    {
        npc_fiendish_portalAI(Creature* creature) : ScriptedAI(creature), summons(me){ }
...
public:
    ...
    struct boss_terestianAI : public ScriptedAI
    {
        ...
        void JustSummoned(Creature* summoned)
        {
            ...
            {
                PortalGUID[PortalsCount].Set(summoned->GetGUID());
                ++PortalsCount;
