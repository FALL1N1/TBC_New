...
public:
    ...
    {
        EscortAI* pEscortAI = CAST_AI(npc_anchorite_truuen::npc_anchorite_truuenAI, creature->AI());
    ...
    struct npc_anchorite_truuenAI : public EscortAI
    {
        npc_anchorite_truuenAI(Creature* creature) : EscortAI(creature) { }
